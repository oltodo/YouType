...
const Component = React.memo(
  React.forwardRef((props, ref) => (
    <SvgIcon data-mui-test="Refresh1" viewBox="0 0 48 48" ref={ref} {...props}>
      ...
      <path
        ...
        opacity=".3"
      />
      <path d="M43.862 29.027l.063.014.107.03.18.07.114.06.097.061.124.095.09.082.063.068.094.119.045.065c.042.066.08.135.111.208l.019.044c.069.172.107.36.107.557v13a1.5 1.5 0 11-3 0l-.001-9.379-.974.975a1.5 1.5 0 11-2.122-2.121l3.599-3.595.107-.087.108-.073.124-.068.098-.044a1.488 1.488 0 01.847-.08z" />
    </SvgIcon>
  )),
);

if (process.env.NODE_ENV !== "production") {
  Component.displayName = `Refresh1`;
}
